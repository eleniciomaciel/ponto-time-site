    ...
    <td align="center" valign="top" width="100%" style="background-color: #f7f7f7;" class="content-padding">
      <center>
        <table cellspacing="0" cellpadding="0" width="600" class="w320">
          <tr>
            <td class="header-lg">
             C8-Sistemas Tecnologia Ponto Time
            </td>
          </tr>
          <tr>
            <td class="free-text">
                      ...
                      <tr>
                        <td class="mini-block-padding">
                          <table cellspacing="0" cellpadding="0" width="100%" style="border-collapse:separate !important;">
                            <tr>
                              <td class="mini-block">
                                <span class="header-sm">Dados do colaborador</span><br />
									<b>Nome:</b> Jane Doe <br />
									<b>Cargo:</b> Gerente<br />
									<b>Matrícula:</b> 123455
                              </td>
                            </tr>
                          </table>
                        </td>
                      ...
                      <tr>
                        <td class="mini-block-padding">
                          <table cellspacing="0" cellpadding="0" width="100%" style="border-collapse:separate !important;">
                            <tr>
                              <td class="mini-block">
                                <span class="header-sm">Dados do ponto</span><br />
									<b>Tipo:</b> Entrada <br />
									<b>Hora:</b> 10:00 hs<br />
									<b>Turno:</b> Comércial
                              </td>
                            </tr>
                          </table>
                ...
                <table cellspacing="0" cellpadding="0" width="100%">
                  ...
                  <tr>
                    ...
                    <td class="item-col quantity" style="text-align:right; padding-right: 10px; border-top: 1px solid #cccccc;">
                      ...
                      <span class="total-space" style="font-weight: bold; color: #4d4d4d">Horas trabalhada</span>
                    </td>
                    <td class="item-col price" style="text-align: left; border-top: 1px solid #cccccc;">
                      
                      <span class="total-space" style="font-weight:bold; color: #4d4d4d">61 hs</span>
                    </td>
                  </tr>  
                </table>
              </td>
        ...
        <table cellspacing="0" cellpadding="0" width="600" class="w320">
          <tr>
            <td style="padding: 25px 0 25px">
              <strong>Casa dos Doces S/A</strong><br />
              Rua Florido Antunes, nº 500<br />
              Senhor do Bonfim - BA <br /><br />
            </td>
          </tr>
        </table>
      </center>
