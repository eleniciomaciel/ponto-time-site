...
<html class="no-js" lang="pt-br">
	<head>
		...
		<title>Login | C8 Ponto time</title>
		<meta name="description" content="C8 Sistemas. Ponto Time, sistema de acesso para funcionários.">
		<meta name="author" content="C8 Sistemas | www.c8sistemas.com.br">
		...
		<!-- Styles -->
		<link rel="stylesheet" href="stylus/css/sangoma-purple.css">

		<!-- JS Libs -->
		<script src="//ajax.googleapis.com/ajax/libs/jquery/1.10.2/jquery.min.js"></script>
		<script>window.jQuery || document.write('<script src="stylus/js/libs/jquery.js"><\/script>')</script>
		<script src="stylus/js/libs/modernizr.js"></script>
